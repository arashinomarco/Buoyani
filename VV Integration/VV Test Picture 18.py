...
def update(frame, particles, scatters, yellow_dot_position):
    update_acceleration(particles, yellow_dot_position)
...
yellow_dot_position = np.array([-1500, 0])
...
ani = animation.FuncAnimation(fig, update, frames=num_frames, fargs=(particles, scatters, yellow_dot_position), blit=True)
